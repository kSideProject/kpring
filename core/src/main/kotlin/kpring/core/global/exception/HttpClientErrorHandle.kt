...
object HttpClientErrorHandle {
   ...
   */
  fun rest4xxHandle(): (request: HttpRequest, response: ClientHttpResponse) -> Unit =
    { req, res ->
      val body =
        BufferedReader(InputStreamReader(res.body, StandardCharsets.UTF_8))
          .lines()
   ...
   */
  fun rest5xxHandle(): (request: HttpRequest, response: ClientHttpResponse) -> Unit =
    { req, res ->
      val body =
        BufferedReader(InputStreamReader(res.body, StandardCharsets.UTF_8))
          .lines()
